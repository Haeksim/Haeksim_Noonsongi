...
def get_agent_executor():
    ...
    """
    # agent가 사용할 tools
    tools = [generate_lyrics_tool, generate_song_via_api,read_lyrics_file_tool]
    
    # system_message prompt
    system_message_string = "You are a music producer. You must use tools to generate lyrics first, then generate a song."
